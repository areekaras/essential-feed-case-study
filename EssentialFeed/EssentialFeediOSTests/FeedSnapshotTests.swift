...
//
//  Created by Shibili Areekara on 13/01/23.
//
...
private extension UIViewController {
    func snapshot(for configuaration: SnapshotConfiguration) -> UIImage {
        return SnapshotWindow(configuration: configuaration, root: self).snapshot()
    }
}
